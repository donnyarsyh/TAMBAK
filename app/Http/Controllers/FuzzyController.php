...
class FuzzyController extends Controller
{
    public function hitungFuzzy(Request $request)
    {
        try {
            ...
            $ph = (float) $request->ph;
            $tds_ppm = (float) $request->salinitas; 
            ...
            // klasifikasi untuk memberikan label pada nilai z
    ...
    public function fuzzifikasiph($x) {
        ...
        else if ($x >= 7.0 && $x <= 7.5) $mu['sedang'] = (7.5 - $x) / (7.5 - 7.0); // Perhatikan x <= 7.0 sesuai tabel
    ...
    public function inferensiTsukamoto($muS, $muP, $muL) {
        ...
        // fungsi MIN karena di logika AND, kebenaran aturan ditentukan oleh kriteria yang paling rendah
        ...
        $rules[] = ['a' => min($muS['sedang'], $muP['sedang'], $muL['sedang']), 'z' => $zBaik];   // R8
        ...
        $rules[] = ['a' => min($muS['baik'],   $muP['sedang'], $muL['buruk']),  'z' => $zSedang]; // R12
        $rules[] = ['a' => min($muS['baik'],   $muP['buruk'],  $muL['sedang']), 'z' => $zSedang]; // R13
        $rules[] = ['a' => min($muS['sedang'], $muP['baik'],   $muL['buruk']),  'z' => $zSedang]; // R14
        $rules[] = ['a' => min($muS['sedang'], $muP['buruk'],  $muL['baik']),   'z' => $zSedang]; // R15
        $rules[] = ['a' => min($muS['buruk'],  $muP['sedang'], $muL['baik']),   'z' => $zSedang]; // R16
        $rules[] = ['a' => min($muS['buruk'],  $muP['baik'],   $muL['sedang']), 'z' => $zSedang]; // R17
        $rules[] = ['a' => min($muS['buruk'],  $muP['sedang'], $muL['sedang']), 'z' => $zSedang]; // R18
        $rules[] = ['a' => min($muS['sedang'], $muP['sedang'], $muL['buruk']),  'z' => $zSedang]; // R19
        $rules[] = ['a' => min($muS['sedang'], $muP['buruk'],  $muL['sedang']), 'z' => $zSedang]; // R20
        $rules[] = ['a' => min($muS['buruk'],  $muP['buruk'],  $muL['baik']),   'z' => $zSedang]; // R21
        $rules[] = ['a' => min($muS['buruk'],  $muP['baik'],   $muL['buruk']),  'z' => $zSedang]; // R22
        $rules[] = ['a' => min($muS['baik'],   $muP['buruk'],  $muL['buruk']),  'z' => $zSedang]; // R23
        ...
        // foreach untuk menjumlahkan semua aturan yg aktif secara berulang
